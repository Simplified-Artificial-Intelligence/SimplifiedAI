...
df = pd.read_csv(r'E:\iNeuron\Full Stack Data Science\Python Assignment\Notebook\winequality-red.csv')

y = df['quality']
X_scaled = df.drop(columns='quality')
...
model.support_vector_classifier(kernel='rbf', degree=3)
