...
LinearRegression_Params=[
    {"name":"fit_intercept","type":"select","values":[True,False],"type":"select","dtype":"boolean"},
    {"name":"positive","type":"select","values":[False,True],"type":"select","dtype":"boolean"}
]
...
AdabootRegressor_Params = [{"name":"base_estimator", "type":"input", "values":None, "dtype":"object", "accept_none":True},
...
LogisticRegression_Params=[
    {"name":"penalty","type":"select","values":['l2','l1', 'elasticnet', 'None'], "dtype":"string", "accept_none":True},
    {"name":"dual","type":"select","values":[False,True], "dtype":"boolean", "accept_none":False},
    {"name":"tol","type":"input","values":"0.0001", "dtype":"float", "accept_none":False},
    {"name":"C","type":"input","values":"1.0", "dtype":"float", "accept_none":False},
    {"name":"fit_intercept","type":"select","values":[True, False], "dtype":"boolean", "accept_none":False},
    {"name":"intercept_scaling","type":"input","values":"1", "dtype":"float", "accept_none":False},
    {"name":"class_weight","type":"select","values":["", 'balanced'], "dtype":"string", "accept_none":True},
    {"name":"random_state","type":"input","values":"", "dtype":"int", "accept_none":True},
    {"name":"solver","type":"select","values":["lbfgs", "newton-cg", "liblinear", "sag", "saga"], "dtype":"string", "accept_none":False},
    {"name":"max_iter","type":"input","values":"100", "dtype":"int", "accept_none":False},
    {"name":"multi_class","type":"select","values":["auto", "ovr", "multinomial"], "dtype":"string", "accept_none":False},
    {"name":"verbose","type":"input","values":"0", "dtype":"int", "accept_none":False},
    {"name":"warm_start","type":"select","values":[False,True], "dtype":"boolean", "accept_none":False},
    {"name":"n_jobs","type":"input","values":"", "dtype":"int", "accept_none":True},
    {"name":"l1_ratio","type":"input","values":"", "dtype":"float", "accept_none":True}]
    
             
SVC_Params= [
    {"name":"C","type":"input","values":"1.0", "dtype":"float", "accept_none":False},
    {"name":"kernel","type":"select","values":['rbf', 'poly', 'sigmoid', 'linear', 'precomputed'], "dtype":"string", "accept_none":False},
    {"name":"degree","type":"input","values":"3", "dtype":"int", "accept_none":False},
...
KNeighborsClassifier_Params = [
    ...
    {"name":"algorithm","type":"selet","values":["auto","ball_tree","kd_tree", "brute"], "dtype":"string", "accept_none":False},
    {"name":"leaf_size","type":"input","values":"30", "dtype":"int", "accept_none":False},
    {"name":"p","type":"input","values":"2", "dtype":"int", "accept_none":True},
    {"name":"metric","type":"select","values":['minkowski', 'euclidean', 'manhattan', 'chebyshev', 'mahalanobis'], "dtype":"string", "accept_none":False},
    {"name":"n_jobs","type":"input","values":"", "dtype":"int", "accept_none":True}
] 
...
DecisionTreeClassifier_Params = [
    ...
    {"name":"min_samples_leaf","type":"input","values":"1", "dtype":"int", "accept_none":False},
    {"name":"min_weight_fraction_leaf","type":"input","values":"0.0", "dtype":"float", "accept_none":False},
    {"name":"max_features","type":"select","values":["","auto", "sqrt", "log2"], "dtype":"string", "accept_none":True},
    {"name":"random_state","type":"input","values":"", "dtype":"int", "accept_none":True},
    {"name":"max_leaf_nodes","type":"input","values":"", "dtype":"int", "accept_none":True},
...
RandomForestClassifier_Params=[
    ...
    {"name":"verbose","type":"input","values":0, "dtype":"int", "accept_none":False},
    {"name":"warm_start","type":"select","values":[False, True], "dtype":"boolean", "accept_none":False},
    {"name":"class_weight","type":"select","values":["","balanced", "balanced_subsample"], "dtype":"string", "accept_none":True},
    {"name":"ccp_alpha","type":"input","values":0.0, "dtype":"float", "accept_none":True},
...
GradientBoostingClassifier_Params=[
    ...
    {"name":"n_estimators","type":"input","values":100, "dtype":"int", "accept_none":False},
    {"name":"subsample","type":"input","values":1.0, "dtype":"float", "accept_none":False},
    {"name":"criterion","type":"select","values":["friedman_mse", "squared_error", "mae"], "dtype":"string", "accept_none":False},
    {"name":"min_samples_split","type":"input","values":2, "dtype":"int", "accept_none":False},
    {"name":"min_samples_leaf","type":"input","values":1, "dtype":"int", "accept_none":False},
    {"name":"min_weight_fraction_leaf","type":"input","values":0.0, "dtype":"float", "accept_none":False},
    {"name":"max_depth","type":"input","values":3, "dtype":"int", "accept_none":False},
...
AdaBoostClassifier_Params=[
    {"name":"base_estimator","type":"select","values":["","DecisionTreeClassifier"], "dtype":"string", "accept_none":True},
    {"name":"n_estimators","type":"input","values":50, "dtype":"int", "accept_none":False},
    {"name":"learning_rate","type":"float","values":1.0, "dtype":"float", "accept_none":False},
...
KmeansClustering_Params=[
    ...
    {"name":"algorithm","type":"select","values":["auto", "full", "elkan"], "dtype":"string", "accept_none":False}]
...
DbscanClustering_Params=[
    ...
    {"name":"metric","type":"select","values":['euclidean','cityblock', 'cosine','l1', 'l2', 'manhattan'], "dtype":"string", "accept_none":False},
    {"name":"algorithm","type":"select","values":["auto", "ball_tree", "kd_tree", "brute"], "dtype":"string", "accept_none":False},
    {"name":"leaf_size","type":"input","values":30, "dtype":"int", "accept_none":False},
...
AgglomerativeClustering_Params=[
    ...
    {"name":"linkage","type":"select","values":["ward", "complete", "average", "single"], "dtype":"string", "accept_none":False},
